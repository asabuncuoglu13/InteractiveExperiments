...
public class CodeBlocksCompiler {
    ...
    int l_start = 6; int l_end = 4;
    int l_if = 2; int l_else = 5;
    int l_for = 3; int l_while = 5;
    ...
    private String checkStartEnd(String code)
    {
        try {
    ...
    private boolean returnIfStatement(String codeline)
    {
    ...
    public int[] returnOutput(String code)
    {
        ...
        if(subCode.contains("IF"))
        {
            ...
            if(returnIfStatement(ifConditionalText))
            {
        ...
        else if(subCode.contains("FOR"))
        {
            ...
            out[0] = Integer.parseInt(times); out[1] = outNum;
            return out;
        }
        else if(subCode.contains("WHILE"))
        {
            int outNum = mapIterator(outputMap, code);
            out[0] = 50; out[1] = outNum;
            return out;
        }
        else
        {
