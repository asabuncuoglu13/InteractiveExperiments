...
public class SimulationParameters {
    ...
    public static int PULLEY_IMAGE = R.drawable.ic_howto;

    public static int[] images = {INCLINED_PLANE_IMAGE, CONSTANT_ACCELERATION_IMAGE, OHMS_LAW_IMAGE, PULLEY_IMAGE};
